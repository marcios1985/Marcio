...
import sty from "./PlasmicButton.module.css"; // plasmic-import: C340TtQ1qMJ_/css
  ...
  return (
    <Stack__
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootcolors_black_size_large_rounded_showEndIcon]:
            hasVariant($state, "showEndIcon", "showEndIcon") &&
            hasVariant($state, "colors", "black") &&
    ...
    >
      {(
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__k5OaZ, {
            [sty.freeBoxiconOnly__k5OaZq0KfG]: hasVariant(
              $state,
              "iconOnly",
              "iconOnly"
            ),
            [sty.freeBoxshowEndIcon__k5OaZxe2Ie]: hasVariant(
              $state,
              "showEndIcon",
              "showEndIcon"
            ),
            [sty.freeBoxshowStartIcon__k5OaZaX4Xq]: hasVariant(
              $state,
              "showStartIcon",
              "showStartIcon"
            ),
            [sty.freeBoxsize_large__k5OaZpeSbX]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__k5OaZuzjYw]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <MenuIcon
                className={classNames(projectcss.all, sty.svg__xWvT4)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__aUkUt, {
            [sty.freeBoxshowEndIcon__aUkUtxe2Ie]: hasVariant(
              $state,
              "showEndIcon",
              "showEndIcon"
            ),
            [sty.freeBoxsize_small__aUkUTuzjYw]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false)
            ? renderPlasmicSlot({
                defaultContents: (
                  <MenuIcon
                    className={classNames(projectcss.all, sty.svg___4WTx8)}
                    role={"img"}
                  />
                ),
