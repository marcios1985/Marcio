...
import sty from "./PlasmicCopyrightSocialLanguage.module.css"; // plasmic-import: CxPoe5mhD0gN/css

import TwitterIcon from "./icons/PlasmicIcon__Twitter"; // plasmic-import: UlxvMenxzLoc/icon
import MenuIcon from "./icons/PlasmicIcon__Menu"; // plasmic-import: gtiXXUGcCZ-V/icon
import YoutubeIcon from "./icons/PlasmicIcon__Youtube"; // plasmic-import: 3slWfiTHmmRZ/icon
import PintrestIcon from "./icons/PlasmicIcon__Pintrest"; // plasmic-import: e_W6_cyVuRXc/icon
import Icon15Icon from "./icons/PlasmicIcon__Icon15"; // plasmic-import: _asRUpKSU6MO/icon
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___1MUi)}
      >
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__aYQw)}
        >
          <div
          ...
          <div className={classNames(projectcss.all, sty.freeBox___0CrA)}>
            <Button
              iconOnly={true}
              link={"http://twitter.com"}
              startIcon={
                <TwitterIcon
                  className={classNames(projectcss.all, sty.svg__jIyLb)}
                  role={"img"}
                />
              }
              submitsForm={true}
            ...
            <Button
              className={classNames("__wab_instance", sty.button__eSxsO)}
              iconOnly={true}
              link={"http://youtube.com"}
              startIcon={
                <YoutubeIcon
                  className={classNames(projectcss.all, sty.svg___2T6Fd)}
                  role={"img"}
                />
              }
              submitsForm={true}
            ...
            <Button
              className={classNames("__wab_instance", sty.button__skop)}
              iconOnly={true}
              link={"http://pinterest.com"}
              startIcon={
                <PintrestIcon
                  className={classNames(projectcss.all, sty.svg___6AVc)}
                  role={"img"}
                />
              }
              submitsForm={true}
        ...
        <Button
          className={classNames("__wab_instance", sty.button__h7Y5Q)}
          endIcon={
            <Icon15Icon
              className={classNames(projectcss.all, sty.svg__ciiU3)}
              role={"img"}
            />
          }
          showEndIcon={true}
          startIcon={
            <Icon15Icon
              className={classNames(projectcss.all, sty.svg__oBcn0)}
              role={"img"}
            />
          }
          submitsForm={true}
