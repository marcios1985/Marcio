...
import sty from "./PlasmicValue.module.css"; // plasmic-import: 7dtSRzTgoyFA/css

import TakeOffIcon from "./icons/PlasmicIcon__TakeOff"; // plasmic-import: w3YwlOEBY85u/icon
...
function PlasmicValue__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__c7Yxy, {
          [sty.freeBoxcenter__c7Yxyq9Wu9]: hasVariant(
            $state,
            "center",
            "center"
          ),
          [sty.freeBoxtopBottom__c7Yxy0Sjjq]: hasVariant(
            $state,
            "topBottom",
            "topBottom"
          )
      ...
      >
        <div className={classNames(projectcss.all, sty.freeBox___2SWJ)}>
          {renderPlasmicSlot({
            defaultContents: (
              <TakeOffIcon
                className={classNames(projectcss.all, sty.svg__yDoR2)}
                role={"img"}
              />
            ),
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__lMiHh, {
          [sty.freeBoxcenter__lMiHhq9Wu9]: hasVariant(
            $state,
            "center",
            "center"
          ),
          [sty.freeBoxwithButton__lMiHhxuKlC]: hasVariant(
            $state,
            "withButton",
            "withButton"
          )
      ...
      {(hasVariant($state, "withButton", "withButton") ? true : false) ? (
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__kpn6, {
            [sty.freeBoxcenter__kpn6Q9Wu9]: hasVariant(
              $state,
              "center",
              "center"
            ),
            [sty.freeBoxwithButton__kpn6XuKlC]: hasVariant(
              $state,
              "withButton",
              "withButton"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Button
                className={classNames("__wab_instance", sty.button__zNuBw, {
                  [sty.buttonwithButton__zNuBWxuKlC]: hasVariant(
                    $state,
                    "withButton",
                    "withButton"
                  )
                ...
                endIcon={
                  <RightArrowIcon
                    className={classNames(projectcss.all, sty.svg__toFch)}
                    role={"img"}
                  />
                }
                rounded={true}
